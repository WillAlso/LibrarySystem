                ...
                if (m == QUERRYUSER) {
                    ...
                    if (cnt > 0) {
                        ...
                        for (int i = 0; i < cnt; i++) {
                            ...
                            Operation op = new Operation(user,book,isbn,date,"未归还",0);
                            oos.writeObject(op);
                            oos.flush();
                        }
                        result3.close();
                    ...
                    if (cnt2 > 0) {
                        ...
                        for (int i = 0; i < cnt2; i++) {
                            ...
                            Operation op = new Operation(user,book,isbn,date,back,0);
                            oos.writeObject(op);
                            oos.flush();
                        }
                        result4.close();
                    ...
                    if(result.next()){
                        ...
                        result.close();
                        String tsql = "DELETE FROM libraryborrow WHERE User='" + user + "' and Name='" + book + "';";
                        String tsql2 = "INSERT FROM libraryborrowed VALUES(0,'" +user + "','" + book +"','" + isbn + "','" +date + "',NOW())";
